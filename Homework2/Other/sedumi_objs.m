function [x,y,info,objs] = sedumi_objs(A,b,c,K,pars)
% [x,y,info,objs] = sedumi_objs(A,b,c,K,pars)
% (modified version of sedumi that returns objective values for every iterate)
%
...
while STOP == 0
    ...
    % Let us record objective function values in vector objs
    objs(iter) = by/x0;
    % ----------------------------------------
